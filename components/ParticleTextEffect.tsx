...
const DEFAULT_WORDS = ['HELLO', 'DEVS', 'SALAMANDER', 'OPEN SOURCE', 'POOL'];
...
export function ParticleTextEffect({ words = DEFAULT_WORDS, className }: ParticleTextEffectProps) {
  ...
  const containerClassName = ['absolute inset-0 pointer-events-none', className].filter(Boolean).join(' ');
